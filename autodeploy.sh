...
# any downtime.
# Example of use:
# $ ./autodeploy.sh jugalanvekar/simpleapi 07 autodply/deployment.yaml
...
# Successfully tagged jugalanvekar/simpleapi:07
# The push refers to repository [docker.io/jugalanvekar/simpleapi]
...
if [ -z "$1" ] || [ -z "$2" ] || [ -z "$3" ]
  then
    ...
    echo "Example: $0 jugalanvekar/simpleapi 04 autodply/deployment.yaml"
    exit 1
fi
